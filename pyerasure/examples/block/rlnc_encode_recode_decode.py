...
def main():
    ...
    encoder = pyblock.Encoder(field, symbols, symbol_bytes)
    recoder = pyblock.Decoder(field, symbols, symbol_bytes)
    decoder = pyblock.Decoder(field, symbols, symbol_bytes)

    # Create generator
    generator = pygenerator.RandomUniform(field, symbols)
